        ...
        <div className="h-auto w-full p-7 rounded-boxRadius bg-insideBoxBg border-solid border-2 border-boxBorder ">
          ...
          <div className="h-56 p-7 rounded-boxRadius bg-boxBg border-solid border-2 border-boxBorder shadow-box-1 font-['JetBrains_Mono'] text-[14px]">
            <span className="text-t-text ">
              [9:37:59 pm]&emsp;
              <span className="text-white">
                Registering for the Project SBOX waitlist...
              </span>
            </span>
            <br />
            <span className="text-t-text ">
            ...
            <br />
            <span className="text-t-text ">
              &emsp;&emsp;&emsp;&emsp;&emsp;&emsp;&emsp;&emsp;&emsp;"Email":&ensp;
              <span className="text-white">"xman@edgex.nex"</span>,
            </span>
            <br />
            <span className="text-t-text ">
            ...
            <span className="text-t-text ">
              [9:38:01 pm]&emsp;
              <span className="text-white">
                🎉<span className="text-acent">Success!</span> You're on the
                waitlist. Stay tuned for updates.
              </span>
            </span>
          </div>
        </div>
